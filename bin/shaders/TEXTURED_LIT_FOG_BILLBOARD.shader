...
void main()
{
	...
	//removing horizontal rotations for cylindrical billboard
	modelView[0][0] = modelMatrix[0][0];
	modelView[0][1] = 0;
	modelView[0][2] = 0;
	modelView[2][0] = 0;
	modelView[2][1] = 0;
	modelView[2][2] = modelMatrix[2][2];
...
//noperspective disables texture perspective for ps1 effect, tesselation not needed for billBoards. For billboards this does not make much of a significant difference
